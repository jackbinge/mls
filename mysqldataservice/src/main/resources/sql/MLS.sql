...
-- ---------------------------------------------------------------------------------------------------------------------
-- 创建数据库
drop database if exists yk_ai;
create database yk_ai default char set utf8 collate utf8_general_ci;
use yk_ai;
...
(
    ...
    ra_target    DOUBLE comment '显色指数,目标值',
...
(
    ...
    euclidean_distance_y  double comment 'x方向欧式距离',
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 初始化组织结构
insert into t_group(parent_id, code, name, map_eas_id, parent_path, level)
values (0, NULL, '木林森股份', NULL, '0', 0);
insert into t_group(parent_id, code, name, map_eas_id, parent_path, level)
values (1, NULL, '中山木林森电子', NULL, '0,1', 1);
insert into t_group(parent_id, code, name, map_eas_id, parent_path, level)
values (2, NULL, '照明器件', NULL, '0,1,2', 2);
insert into t_group(parent_id, code, name, map_eas_id, parent_path, level)
values (3, NULL, '五厂一部', '01.19.20.01.02.061', '0,1,2,3', 3);

-- ---------------------------------------------------------------------------------------------------------------------
-- 初始化权限库
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (1, '在制生产管理', 0, 'productionManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (2, 'EAS工单管理', 1, 'easManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (3, '在制工单管理', 1, 'productionManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (4, '在制详情', 3, 'productionManageInfo', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (5, '在制记录', 3, 'productionManageLog', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (6, '在线监控', 0, 'monitor', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (7, '品质测试', 6, 'test', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (8, '在制详情', 7, 'testInfo', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (9, '在制记录', 7, 'testLog', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (10, '基础数据库', 0, 'baseDataSource', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (11, '点胶设备库', 10, 'glueEquit', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (12, '原材料库', 10, 'rawMaterial', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (13, '机种库', 10, 'machineType', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (14, '色区库', 10, 'colorArea', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (15, '配比库', 10, 'mixtureRatio', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (16, '查看详情', 15, 'mixtureRatioDetail', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (17, '测试规则库', 10, 'testRule', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (18, '后台管理', 0, 'backgroundManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (19, '组织结构管理', 18, 'groupManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (20, '角色管理', 18, 'ruleManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (21, '用户管理', 18, 'userManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (22, '生产车间编码', 18, 'productManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (23, '材料类型编码', 18, 'materialManage', '', 0);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (24, '一键同步', 2, 'synch', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (25, '投产', 2, 'putInto', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (26, '关闭工单', 3, 'close', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (27, '查看在制详情', 3, 'info', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (28, '查看在制记录', 3, 'log', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (29, '开始试样', 4, 'start', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (30, '试样通过', 4, 'success', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (31, '修改配方', 4, 'edits', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (32, '修改配比', 4, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (33, '在制设备管理', 4, 'manage', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (34, '在制详情', 7, 'info', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (35, '在制记录', 7, 'log', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (36, '上传测试结果', 8, 'upload', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (37, '取消NG判定', 8, 'cancle', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (38, '测试结果判定', 8, 'result', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (39, '新增', 11, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (40, '编辑', 11, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (41, '删除', 11, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (42, '新增', 12, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (43, '编辑', 12, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (44, '删除', 12, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (45, '新增', 13, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (46, '编辑', 13, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (47, '删除', 13, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (48, '新增', 14, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (49, '删除', 14, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (50, '查看详情', 15, 'searchInfo', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (51, '生产搭配管理', 16, 'collocationManage', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (52, '编辑配比', 16, 'editMixture', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (53, '编辑', 17, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (54, '新增', 19, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (55, '删除', 19, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (56, '新增', 20, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (57, '编辑', 20, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (58, '删除', 20, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (59, '新增', 21, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (60, '编辑', 21, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (61, '删除', 21, 'delete', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (62, '修改', 21, 'editpwd', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (63, '新增', 22, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (64, '编辑', 22, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (65, '新增', 23, 'add', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (66, '编辑', 23, 'edit', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (67, '修改胶量', 4, 'editdjcs', '', 1);
INSERT INTO `t_privilege`(id, name, parent_id, router, router_path, kind) VALUES (68, '查看', 2, 'ckxq', '', 1);


-- ---------------------------------------------------------------------------------------------------------------------
-- 初始化spc模板规则
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (1, '控制图上有%m个点位于控制线以外', 1, null);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (2, '连续%m点落在中心线的同一侧', 9, null);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (3, '连续%m点递增或递减', 6, null);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (4, '连续%m点中相邻点交替上下', 14, null);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (5, '连续%m点中有%m点落在中心线同一侧的B区以外', 3, 3);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (6, '连续%m点中有%m点落在中心线同一侧的C区之外', 5, 4);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (7, '连续%m点落在C区之内', 15, null);
insert into t_spc_base_rule(rule_no, rule_template, m, n)
values (8, '连续%m点落在中心线两侧，但无%m点在C区之内', 8, 1);


-- ---------------------------------------------------------------------------------------------------------------------
-- 异常异常原因定义表
insert into t_feed_exception_reason(reason, flag)
values ('无芯片', 1),
       ('无支架', 2),
       ('无荧光粉', 3),
       ('胶水规格不足两种', 4),
...
-- 角色
INSERT INTO `t_role`
VALUES (1, 1, '1231', '123', 0, '2019-11-14 18:52:11');
...
VALUES (1, 1, 'admin', 'admin', '4297f44b13955235245b2497399d7a93', 0, 0, '2019-11-17 16:53:49');

-- 新增用户角色
INSERT INTO `t_user_role`(id, user_id, role_id) VALUES (1, 1, 1);

-- 工单状态定义表新增
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (1,'待生产',1);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (2,'试样前测中',2);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (3,'试样前测NG',3);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (4,'试样前测通过',4);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (5,'试样品质测试NG',5);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (6,'批量生产',6);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (7,'批量生产中有阀体NG',7);
INSERT INTO t_task_state_df(id,state_name, state_flag) VALUES (8,'工单关闭',8);

-- 阀体状态定义表
INSERT INTO t_eqpt_valve_state_df(id, state_name, state_flag) VALUES (1,'待生产',1);
INSERT INTO t_eqpt_valve_state_df(id, state_name, state_flag) VALUES (2,'生产中',2);
INSERT INTO t_eqpt_valve_state_df(id, state_name, state_flag) VALUES (3,'阀体NG',3);
INSERT INTO t_eqpt_valve_state_df(id, state_name, state_flag) VALUES (4,'已关闭',4);
