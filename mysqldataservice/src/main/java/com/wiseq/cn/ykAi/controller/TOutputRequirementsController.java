...
public class TOutputRequirementsController {
    ...
    Result selectByTypeMachineId(@RequestParam(value = "typeMachineId") Long typeMachineId,
        ...
        return ResultUtils.success(this.tOutputRequirementsService.selectByTypeMachineId(typeMachineId, outputKind, isTemp, code));
    ...
    Result findTColorTolerance(@RequestParam(value = "typeMachineId") Long typeMachineId){
        return  ResultUtils.success(this.tOutputRequirementsService.findTColorTolerance(typeMachineId));
    }
    ...
    Result findTColorRegionSK(@RequestParam(value = "typeMachineId") Long typeMachineId){
       return ResultUtils.success( this.tOutputRequirementsService.findTColorRegionSK(typeMachineId));
    }
