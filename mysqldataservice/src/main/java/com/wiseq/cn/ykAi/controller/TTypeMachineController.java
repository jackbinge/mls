...
public class TTypeMachineController {
    ...
    Result selectAll(@RequestParam(name = "spec",required =false)String spec,
        ...
        return ResultUtils.success(this.tTypeMachineService.selectAll(spec, processType, disabled, pageNum, pageSize,crystalNumber));
    }
    ...
    Result delete(@RequestParam(name = "id") Long id){
        return this.tTypeMachineService.deleteByPrimaryKey(id);
    }
